...
#n = viewer.add_parameter("n", 0, 1000, 2, 1000, numeric_domain='integer')
b = viewer.add_parameter("b", 0, 10, 1, 100, numeric_domain='real')
...
interval2_set = graph1.add_set(interval2)
interval_set = graph1.add_set(interval)
interval3_set = graph1.add_set(interval3)
...
#a = viewer.add_parameter("a", 0, 1, 0, 200)
#b = viewer.add_parameter("b", 0, 100, 0, 100)
#e = viewer.add_parameter("e", 0, 10, 5, 100)
#f = viewer.add_parameter("f", 0, 10, 5, 100)

#U = lambda x, y: x / (x + y)
#V = lambda x, y: x + y
#X = lambda x, y: (y*x)/(1-x)
#Y = lambda x, y: x - y

#viewer.add_grid(y_func=lambda x, y, a, b: (a)*x + (1-a)*(U(x, y)) + b, x_func=lambda x, y, a: (a)*y + (1-a)*(V(x,y)), params={"a": a}, x_range=(x_lower, x_upper), y_range=(y_lower, y_upper), color="b", alpha=0.1)
